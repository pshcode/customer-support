<%--@elvariable id="contacts" type="java.util.Set<com.contact.Contact>"--%>
<!DOCTYPE html>
<html>
<head>
...
<c:choose>
    ...
    <c:otherwise>
        <c:forEach items="${contacts}" var="contact">
            ...
            <fmt:message key="label.creationDate"/>: <fmt:formatDate value="${contact.oldDateCreated}" type="both" dateStyle="long" timeStyle="long"/> <br/><br/>
        </c:forEach>
    </c:otherwise>
</c:choose>
</body>
